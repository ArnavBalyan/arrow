...
DataPageHeaderV3::DataPageHeaderV3(const DataPageHeaderV3& other166) {
  num_values = other166.num_values;
  num_nulls = other166.num_nulls;
  num_rows = other166.num_rows;
  values_encoding = other166.values_encoding;
  repetition_level_encodings = other166.repetition_level_encodings;
  definition_level_encodings = other166.definition_level_encodings;
  encoding_metadata = other166.encoding_metadata;
  statistics = other166.statistics;
  __isset = other166.__isset;
}
DataPageHeaderV3::DataPageHeaderV3(DataPageHeaderV3&& other167) noexcept {
  num_values = other167.num_values;
  num_nulls = other167.num_nulls;
  num_rows = other167.num_rows;
  values_encoding = other167.values_encoding;
  repetition_level_encodings = std::move(other167.repetition_level_encodings);
  definition_level_encodings = std::move(other167.definition_level_encodings);
  encoding_metadata = std::move(other167.encoding_metadata);
  statistics = std::move(other167.statistics);
  __isset = other167.__isset;
}
DataPageHeaderV3& DataPageHeaderV3::operator=(const DataPageHeaderV3& other168) {
  num_values = other168.num_values;
  num_nulls = other168.num_nulls;
  num_rows = other168.num_rows;
  values_encoding = other168.values_encoding;
  repetition_level_encodings = other168.repetition_level_encodings;
  definition_level_encodings = other168.definition_level_encodings;
  encoding_metadata = other168.encoding_metadata;
  statistics = other168.statistics;
  __isset = other168.__isset;
  return *this;
}
DataPageHeaderV3& DataPageHeaderV3::operator=(DataPageHeaderV3&& other169) noexcept {
  num_values = other169.num_values;
  num_nulls = other169.num_nulls;
  num_rows = other169.num_rows;
  values_encoding = other169.values_encoding;
  repetition_level_encodings = std::move(other169.repetition_level_encodings);
  definition_level_encodings = std::move(other169.definition_level_encodings);
  encoding_metadata = std::move(other169.encoding_metadata);
  statistics = std::move(other169.statistics);
...
SplitBlockAlgorithm::SplitBlockAlgorithm(const SplitBlockAlgorithm& other170) noexcept {
  (void) other170;
}
SplitBlockAlgorithm::SplitBlockAlgorithm(SplitBlockAlgorithm&& other171) noexcept {
  (void) other171;
}
SplitBlockAlgorithm& SplitBlockAlgorithm::operator=(const SplitBlockAlgorithm& other172) noexcept {
  (void) other172;
  return *this;
}
SplitBlockAlgorithm& SplitBlockAlgorithm::operator=(SplitBlockAlgorithm&& other173) noexcept {
  (void) other173;
  return *this;
}
...
BloomFilterAlgorithm::BloomFilterAlgorithm(const BloomFilterAlgorithm& other174) noexcept {
  BLOCK = other174.BLOCK;
  __isset = other174.__isset;
}
BloomFilterAlgorithm::BloomFilterAlgorithm(BloomFilterAlgorithm&& other175) noexcept {
  BLOCK = std::move(other175.BLOCK);
  __isset = other175.__isset;
}
BloomFilterAlgorithm& BloomFilterAlgorithm::operator=(const BloomFilterAlgorithm& other176) noexcept {
  BLOCK = other176.BLOCK;
  __isset = other176.__isset;
  return *this;
}
BloomFilterAlgorithm& BloomFilterAlgorithm::operator=(BloomFilterAlgorithm&& other177) noexcept {
  BLOCK = std::move(other177.BLOCK);
...
XxHash::XxHash(const XxHash& other178) noexcept {
  (void) other178;
}
XxHash::XxHash(XxHash&& other179) noexcept {
  (void) other179;
}
XxHash& XxHash::operator=(const XxHash& other180) noexcept {
  (void) other180;
  return *this;
}
XxHash& XxHash::operator=(XxHash&& other181) noexcept {
  (void) other181;
  return *this;
}
...
BloomFilterHash::BloomFilterHash(const BloomFilterHash& other182) noexcept {
  XXHASH = other182.XXHASH;
  __isset = other182.__isset;
}
BloomFilterHash::BloomFilterHash(BloomFilterHash&& other183) noexcept {
  XXHASH = std::move(other183.XXHASH);
  __isset = other183.__isset;
}
BloomFilterHash& BloomFilterHash::operator=(const BloomFilterHash& other184) noexcept {
  XXHASH = other184.XXHASH;
  __isset = other184.__isset;
  return *this;
}
BloomFilterHash& BloomFilterHash::operator=(BloomFilterHash&& other185) noexcept {
  XXHASH = std::move(other185.XXHASH);
...
Uncompressed::Uncompressed(const Uncompressed& other186) noexcept {
  (void) other186;
}
Uncompressed::Uncompressed(Uncompressed&& other187) noexcept {
  (void) other187;
}
Uncompressed& Uncompressed::operator=(const Uncompressed& other188) noexcept {
  (void) other188;
  return *this;
}
Uncompressed& Uncompressed::operator=(Uncompressed&& other189) noexcept {
  (void) other189;
  return *this;
}
...
BloomFilterCompression::BloomFilterCompression(const BloomFilterCompression& other190) noexcept {
  UNCOMPRESSED = other190.UNCOMPRESSED;
  __isset = other190.__isset;
}
BloomFilterCompression::BloomFilterCompression(BloomFilterCompression&& other191) noexcept {
  UNCOMPRESSED = std::move(other191.UNCOMPRESSED);
  __isset = other191.__isset;
}
BloomFilterCompression& BloomFilterCompression::operator=(const BloomFilterCompression& other192) noexcept {
  UNCOMPRESSED = other192.UNCOMPRESSED;
  __isset = other192.__isset;
  return *this;
}
BloomFilterCompression& BloomFilterCompression::operator=(BloomFilterCompression&& other193) noexcept {
  UNCOMPRESSED = std::move(other193.UNCOMPRESSED);
...
BloomFilterHeader::BloomFilterHeader(const BloomFilterHeader& other194) noexcept {
  numBytes = other194.numBytes;
  algorithm = other194.algorithm;
  hash = other194.hash;
  compression = other194.compression;
}
BloomFilterHeader::BloomFilterHeader(BloomFilterHeader&& other195) noexcept {
  numBytes = other195.numBytes;
  algorithm = std::move(other195.algorithm);
  hash = std::move(other195.hash);
  compression = std::move(other195.compression);
}
BloomFilterHeader& BloomFilterHeader::operator=(const BloomFilterHeader& other196) noexcept {
  numBytes = other196.numBytes;
  algorithm = other196.algorithm;
  hash = other196.hash;
  compression = other196.compression;
  return *this;
}
BloomFilterHeader& BloomFilterHeader::operator=(BloomFilterHeader&& other197) noexcept {
  numBytes = other197.numBytes;
  algorithm = std::move(other197.algorithm);
  hash = std::move(other197.hash);
  compression = std::move(other197.compression);
  return *this;
}
...
PageHeader::PageHeader(const PageHeader& other199) {
  type = other199.type;
  uncompressed_page_size = other199.uncompressed_page_size;
  compressed_page_size = other199.compressed_page_size;
  crc = other199.crc;
  data_page_header = other199.data_page_header;
  index_page_header = other199.index_page_header;
  dictionary_page_header = other199.dictionary_page_header;
  data_page_header_v2 = other199.data_page_header_v2;
  data_page_header_v3 = other199.data_page_header_v3;
  __isset = other199.__isset;
}
PageHeader::PageHeader(PageHeader&& other200) noexcept {
  type = other200.type;
  uncompressed_page_size = other200.uncompressed_page_size;
  compressed_page_size = other200.compressed_page_size;
  crc = other200.crc;
  data_page_header = std::move(other200.data_page_header);
  index_page_header = std::move(other200.index_page_header);
  dictionary_page_header = std::move(other200.dictionary_page_header);
  data_page_header_v2 = std::move(other200.data_page_header_v2);
  data_page_header_v3 = std::move(other200.data_page_header_v3);
  __isset = other200.__isset;
}
PageHeader& PageHeader::operator=(const PageHeader& other201) {
  type = other201.type;
  uncompressed_page_size = other201.uncompressed_page_size;
  compressed_page_size = other201.compressed_page_size;
  crc = other201.crc;
  data_page_header = other201.data_page_header;
  index_page_header = other201.index_page_header;
  dictionary_page_header = other201.dictionary_page_header;
  data_page_header_v2 = other201.data_page_header_v2;
  data_page_header_v3 = other201.data_page_header_v3;
  __isset = other201.__isset;
  return *this;
}
PageHeader& PageHeader::operator=(PageHeader&& other202) noexcept {
  type = other202.type;
  uncompressed_page_size = other202.uncompressed_page_size;
  compressed_page_size = other202.compressed_page_size;
  crc = other202.crc;
  data_page_header = std::move(other202.data_page_header);
  index_page_header = std::move(other202.index_page_header);
  dictionary_page_header = std::move(other202.dictionary_page_header);
  data_page_header_v2 = std::move(other202.data_page_header_v2);
  data_page_header_v3 = std::move(other202.data_page_header_v3);
...
KeyValue::KeyValue(const KeyValue& other203) {
  key = other203.key;
  value = other203.value;
  __isset = other203.__isset;
}
KeyValue::KeyValue(KeyValue&& other204) noexcept {
  key = std::move(other204.key);
  value = std::move(other204.value);
  __isset = other204.__isset;
}
KeyValue& KeyValue::operator=(const KeyValue& other205) {
  key = other205.key;
  value = other205.value;
  __isset = other205.__isset;
  return *this;
}
KeyValue& KeyValue::operator=(KeyValue&& other206) noexcept {
  key = std::move(other206.key);
  value = std::move(other206.value);
...
SortingColumn::SortingColumn(const SortingColumn& other207) noexcept {
  column_idx = other207.column_idx;
  descending = other207.descending;
  nulls_first = other207.nulls_first;
}
SortingColumn::SortingColumn(SortingColumn&& other208) noexcept {
  column_idx = other208.column_idx;
  descending = other208.descending;
  nulls_first = other208.nulls_first;
}
SortingColumn& SortingColumn::operator=(const SortingColumn& other209) noexcept {
  column_idx = other209.column_idx;
  descending = other209.descending;
  nulls_first = other209.nulls_first;
  return *this;
}
SortingColumn& SortingColumn::operator=(SortingColumn&& other210) noexcept {
  column_idx = other210.column_idx;
  descending = other210.descending;
  nulls_first = other210.nulls_first;
  return *this;
}
...
PageEncodingStats::PageEncodingStats(const PageEncodingStats& other213) noexcept {
  page_type = other213.page_type;
  encoding = other213.encoding;
  count = other213.count;
}
PageEncodingStats::PageEncodingStats(PageEncodingStats&& other214) noexcept {
  page_type = other214.page_type;
  encoding = other214.encoding;
  count = other214.count;
}
PageEncodingStats& PageEncodingStats::operator=(const PageEncodingStats& other215) noexcept {
  page_type = other215.page_type;
  encoding = other215.encoding;
  count = other215.count;
  return *this;
}
PageEncodingStats& PageEncodingStats::operator=(PageEncodingStats&& other216) noexcept {
  page_type = other216.page_type;
  encoding = other216.encoding;
  count = other216.count;
  return *this;
}
...
ColumnMetaData::ColumnMetaData(const ColumnMetaData& other244) {
  type = other244.type;
  encodings = other244.encodings;
  path_in_schema = other244.path_in_schema;
  codec = other244.codec;
  num_values = other244.num_values;
  total_uncompressed_size = other244.total_uncompressed_size;
  total_compressed_size = other244.total_compressed_size;
  key_value_metadata = other244.key_value_metadata;
  data_page_offset = other244.data_page_offset;
  index_page_offset = other244.index_page_offset;
  dictionary_page_offset = other244.dictionary_page_offset;
  statistics = other244.statistics;
  encoding_stats = other244.encoding_stats;
  bloom_filter_offset = other244.bloom_filter_offset;
  bloom_filter_length = other244.bloom_filter_length;
  size_statistics = other244.size_statistics;
  geospatial_statistics = other244.geospatial_statistics;
  __isset = other244.__isset;
}
ColumnMetaData::ColumnMetaData(ColumnMetaData&& other245) noexcept {
  type = other245.type;
  encodings = std::move(other245.encodings);
  path_in_schema = std::move(other245.path_in_schema);
  codec = other245.codec;
  num_values = other245.num_values;
  total_uncompressed_size = other245.total_uncompressed_size;
  total_compressed_size = other245.total_compressed_size;
  key_value_metadata = std::move(other245.key_value_metadata);
  data_page_offset = other245.data_page_offset;
  index_page_offset = other245.index_page_offset;
  dictionary_page_offset = other245.dictionary_page_offset;
  statistics = std::move(other245.statistics);
  encoding_stats = std::move(other245.encoding_stats);
  bloom_filter_offset = other245.bloom_filter_offset;
  bloom_filter_length = other245.bloom_filter_length;
  size_statistics = std::move(other245.size_statistics);
  geospatial_statistics = std::move(other245.geospatial_statistics);
  __isset = other245.__isset;
}
ColumnMetaData& ColumnMetaData::operator=(const ColumnMetaData& other246) {
  type = other246.type;
  encodings = other246.encodings;
  path_in_schema = other246.path_in_schema;
  codec = other246.codec;
  num_values = other246.num_values;
  total_uncompressed_size = other246.total_uncompressed_size;
  total_compressed_size = other246.total_compressed_size;
  key_value_metadata = other246.key_value_metadata;
  data_page_offset = other246.data_page_offset;
  index_page_offset = other246.index_page_offset;
  dictionary_page_offset = other246.dictionary_page_offset;
  statistics = other246.statistics;
  encoding_stats = other246.encoding_stats;
  bloom_filter_offset = other246.bloom_filter_offset;
  bloom_filter_length = other246.bloom_filter_length;
  size_statistics = other246.size_statistics;
  geospatial_statistics = other246.geospatial_statistics;
  __isset = other246.__isset;
  return *this;
}
ColumnMetaData& ColumnMetaData::operator=(ColumnMetaData&& other247) noexcept {
  type = other247.type;
  encodings = std::move(other247.encodings);
  path_in_schema = std::move(other247.path_in_schema);
  codec = other247.codec;
  num_values = other247.num_values;
  total_uncompressed_size = other247.total_uncompressed_size;
  total_compressed_size = other247.total_compressed_size;
  key_value_metadata = std::move(other247.key_value_metadata);
  data_page_offset = other247.data_page_offset;
  index_page_offset = other247.index_page_offset;
  dictionary_page_offset = other247.dictionary_page_offset;
  statistics = std::move(other247.statistics);
  encoding_stats = std::move(other247.encoding_stats);
  bloom_filter_offset = other247.bloom_filter_offset;
  bloom_filter_length = other247.bloom_filter_length;
  size_statistics = std::move(other247.size_statistics);
  geospatial_statistics = std::move(other247.geospatial_statistics);
...
EncryptionWithFooterKey::EncryptionWithFooterKey(const EncryptionWithFooterKey& other248) noexcept {
  (void) other248;
}
EncryptionWithFooterKey::EncryptionWithFooterKey(EncryptionWithFooterKey&& other249) noexcept {
  (void) other249;
}
EncryptionWithFooterKey& EncryptionWithFooterKey::operator=(const EncryptionWithFooterKey& other250) noexcept {
  (void) other250;
  return *this;
}
EncryptionWithFooterKey& EncryptionWithFooterKey::operator=(EncryptionWithFooterKey&& other251) noexcept {
  (void) other251;
  return *this;
}
...
EncryptionWithColumnKey::EncryptionWithColumnKey(const EncryptionWithColumnKey& other258) {
  path_in_schema = other258.path_in_schema;
  key_metadata = other258.key_metadata;
  __isset = other258.__isset;
}
EncryptionWithColumnKey::EncryptionWithColumnKey(EncryptionWithColumnKey&& other259) noexcept {
  path_in_schema = std::move(other259.path_in_schema);
  key_metadata = std::move(other259.key_metadata);
  __isset = other259.__isset;
}
EncryptionWithColumnKey& EncryptionWithColumnKey::operator=(const EncryptionWithColumnKey& other260) {
  path_in_schema = other260.path_in_schema;
  key_metadata = other260.key_metadata;
  __isset = other260.__isset;
  return *this;
}
EncryptionWithColumnKey& EncryptionWithColumnKey::operator=(EncryptionWithColumnKey&& other261) noexcept {
  path_in_schema = std::move(other261.path_in_schema);
  key_metadata = std::move(other261.key_metadata);
...
ColumnCryptoMetaData::ColumnCryptoMetaData(const ColumnCryptoMetaData& other262) {
  ENCRYPTION_WITH_FOOTER_KEY = other262.ENCRYPTION_WITH_FOOTER_KEY;
  ENCRYPTION_WITH_COLUMN_KEY = other262.ENCRYPTION_WITH_COLUMN_KEY;
  __isset = other262.__isset;
}
ColumnCryptoMetaData::ColumnCryptoMetaData(ColumnCryptoMetaData&& other263) noexcept {
  ENCRYPTION_WITH_FOOTER_KEY = std::move(other263.ENCRYPTION_WITH_FOOTER_KEY);
  ENCRYPTION_WITH_COLUMN_KEY = std::move(other263.ENCRYPTION_WITH_COLUMN_KEY);
  __isset = other263.__isset;
}
ColumnCryptoMetaData& ColumnCryptoMetaData::operator=(const ColumnCryptoMetaData& other264) {
  ENCRYPTION_WITH_FOOTER_KEY = other264.ENCRYPTION_WITH_FOOTER_KEY;
  ENCRYPTION_WITH_COLUMN_KEY = other264.ENCRYPTION_WITH_COLUMN_KEY;
  __isset = other264.__isset;
  return *this;
}
ColumnCryptoMetaData& ColumnCryptoMetaData::operator=(ColumnCryptoMetaData&& other265) noexcept {
  ENCRYPTION_WITH_FOOTER_KEY = std::move(other265.ENCRYPTION_WITH_FOOTER_KEY);
  ENCRYPTION_WITH_COLUMN_KEY = std::move(other265.ENCRYPTION_WITH_COLUMN_KEY);
...
ColumnChunk::ColumnChunk(const ColumnChunk& other266) {
  file_path = other266.file_path;
  file_offset = other266.file_offset;
  meta_data = other266.meta_data;
  ...
  crypto_metadata = other266.crypto_metadata;
  encrypted_column_metadata = other266.encrypted_column_metadata;
  __isset = other266.__isset;
}
ColumnChunk::ColumnChunk(ColumnChunk&& other267) noexcept {
  file_path = std::move(other267.file_path);
  file_offset = other267.file_offset;
  meta_data = std::move(other267.meta_data);
  offset_index_offset = other267.offset_index_offset;
  offset_index_length = other267.offset_index_length;
  column_index_offset = other267.column_index_offset;
  column_index_length = other267.column_index_length;
  crypto_metadata = std::move(other267.crypto_metadata);
  encrypted_column_metadata = std::move(other267.encrypted_column_metadata);
  __isset = other267.__isset;
}
ColumnChunk& ColumnChunk::operator=(const ColumnChunk& other268) {
  file_path = other268.file_path;
  file_offset = other268.file_offset;
  meta_data = other268.meta_data;
  offset_index_offset = other268.offset_index_offset;
  offset_index_length = other268.offset_index_length;
  column_index_offset = other268.column_index_offset;
  column_index_length = other268.column_index_length;
  crypto_metadata = other268.crypto_metadata;
  encrypted_column_metadata = other268.encrypted_column_metadata;
  __isset = other268.__isset;
  return *this;
}
ColumnChunk& ColumnChunk::operator=(ColumnChunk&& other269) noexcept {
  file_path = std::move(other269.file_path);
  file_offset = other269.file_offset;
  meta_data = std::move(other269.meta_data);
  offset_index_offset = other269.offset_index_offset;
  offset_index_length = other269.offset_index_length;
  column_index_offset = other269.column_index_offset;
  column_index_length = other269.column_index_length;
  crypto_metadata = std::move(other269.crypto_metadata);
  encrypted_column_metadata = std::move(other269.encrypted_column_metadata);
...
RowGroup::RowGroup(RowGroup&& other283) noexcept {
  columns = std::move(other283.columns);
  total_byte_size = other283.total_byte_size;
  num_rows = other283.num_rows;
  sorting_columns = std::move(other283.sorting_columns);
  file_offset = other283.file_offset;
  total_compressed_size = other283.total_compressed_size;
  ordinal = other283.ordinal;
  __isset = other283.__isset;
}
RowGroup& RowGroup::operator=(const RowGroup& other284) {
  columns = other284.columns;
  total_byte_size = other284.total_byte_size;
  num_rows = other284.num_rows;
  sorting_columns = other284.sorting_columns;
  file_offset = other284.file_offset;
  total_compressed_size = other284.total_compressed_size;
  ordinal = other284.ordinal;
  __isset = other284.__isset;
  return *this;
}
RowGroup& RowGroup::operator=(RowGroup&& other285) noexcept {
  columns = std::move(other285.columns);
  total_byte_size = other285.total_byte_size;
  num_rows = other285.num_rows;
  sorting_columns = std::move(other285.sorting_columns);
  file_offset = other285.file_offset;
  total_compressed_size = other285.total_compressed_size;
  ordinal = other285.ordinal;
...
TypeDefinedOrder::TypeDefinedOrder(const TypeDefinedOrder& other286) noexcept {
  (void) other286;
}
TypeDefinedOrder::TypeDefinedOrder(TypeDefinedOrder&& other287) noexcept {
  (void) other287;
}
TypeDefinedOrder& TypeDefinedOrder::operator=(const TypeDefinedOrder& other288) noexcept {
  (void) other288;
  return *this;
}
TypeDefinedOrder& TypeDefinedOrder::operator=(TypeDefinedOrder&& other289) noexcept {
  (void) other289;
  return *this;
}
...
ColumnOrder::ColumnOrder(const ColumnOrder& other290) noexcept {
  TYPE_ORDER = other290.TYPE_ORDER;
  __isset = other290.__isset;
}
ColumnOrder::ColumnOrder(ColumnOrder&& other291) noexcept {
  TYPE_ORDER = std::move(other291.TYPE_ORDER);
  __isset = other291.__isset;
}
ColumnOrder& ColumnOrder::operator=(const ColumnOrder& other292) noexcept {
  TYPE_ORDER = other292.TYPE_ORDER;
  __isset = other292.__isset;
  return *this;
}
ColumnOrder& ColumnOrder::operator=(ColumnOrder&& other293) noexcept {
  TYPE_ORDER = std::move(other293.TYPE_ORDER);
...
OffsetIndex::OffsetIndex(const OffsetIndex& other310) {
  page_locations = other310.page_locations;
  unencoded_byte_array_data_bytes = other310.unencoded_byte_array_data_bytes;
  __isset = other310.__isset;
}
OffsetIndex::OffsetIndex(OffsetIndex&& other311) noexcept {
  page_locations = std::move(other311.page_locations);
  unencoded_byte_array_data_bytes = std::move(other311.unencoded_byte_array_data_bytes);
  __isset = other311.__isset;
}
OffsetIndex& OffsetIndex::operator=(const OffsetIndex& other312) {
  page_locations = other312.page_locations;
  unencoded_byte_array_data_bytes = other312.unencoded_byte_array_data_bytes;
  __isset = other312.__isset;
  return *this;
}
OffsetIndex& OffsetIndex::operator=(OffsetIndex&& other313) noexcept {
  page_locations = std::move(other313.page_locations);
  unencoded_byte_array_data_bytes = std::move(other313.unencoded_byte_array_data_bytes);
...
ColumnIndex::ColumnIndex(const ColumnIndex& other351) {
  null_pages = other351.null_pages;
  min_values = other351.min_values;
  max_values = other351.max_values;
  boundary_order = other351.boundary_order;
  null_counts = other351.null_counts;
  repetition_level_histograms = other351.repetition_level_histograms;
  definition_level_histograms = other351.definition_level_histograms;
  __isset = other351.__isset;
}
ColumnIndex::ColumnIndex(ColumnIndex&& other352) noexcept {
  null_pages = std::move(other352.null_pages);
  min_values = std::move(other352.min_values);
  max_values = std::move(other352.max_values);
  boundary_order = other352.boundary_order;
  null_counts = std::move(other352.null_counts);
  repetition_level_histograms = std::move(other352.repetition_level_histograms);
  definition_level_histograms = std::move(other352.definition_level_histograms);
  __isset = other352.__isset;
}
ColumnIndex& ColumnIndex::operator=(const ColumnIndex& other353) {
  null_pages = other353.null_pages;
  min_values = other353.min_values;
  max_values = other353.max_values;
  boundary_order = other353.boundary_order;
  null_counts = other353.null_counts;
  repetition_level_histograms = other353.repetition_level_histograms;
  definition_level_histograms = other353.definition_level_histograms;
  __isset = other353.__isset;
  return *this;
}
ColumnIndex& ColumnIndex::operator=(ColumnIndex&& other354) noexcept {
  null_pages = std::move(other354.null_pages);
  min_values = std::move(other354.min_values);
  max_values = std::move(other354.max_values);
  boundary_order = other354.boundary_order;
  null_counts = std::move(other354.null_counts);
  repetition_level_histograms = std::move(other354.repetition_level_histograms);
  definition_level_histograms = std::move(other354.definition_level_histograms);
...
AesGcmV1::AesGcmV1(const AesGcmV1& other355) {
...
AesGcmV1::AesGcmV1(AesGcmV1&& other356) noexcept {
...
AesGcmV1& AesGcmV1::operator=(const AesGcmV1& other357) {
...
AesGcmV1& AesGcmV1::operator=(AesGcmV1&& other358) noexcept {
...
AesGcmCtrV1::AesGcmCtrV1(const AesGcmCtrV1& other359) {
  aad_prefix = other359.aad_prefix;
  aad_file_unique = other359.aad_file_unique;
  supply_aad_prefix = other359.supply_aad_prefix;
  __isset = other359.__isset;
}
AesGcmCtrV1::AesGcmCtrV1(AesGcmCtrV1&& other360) noexcept {
  aad_prefix = std::move(other360.aad_prefix);
  aad_file_unique = std::move(other360.aad_file_unique);
  supply_aad_prefix = other360.supply_aad_prefix;
  __isset = other360.__isset;
}
AesGcmCtrV1& AesGcmCtrV1::operator=(const AesGcmCtrV1& other361) {
  aad_prefix = other361.aad_prefix;
  aad_file_unique = other361.aad_file_unique;
  supply_aad_prefix = other361.supply_aad_prefix;
  __isset = other361.__isset;
  return *this;
}
AesGcmCtrV1& AesGcmCtrV1::operator=(AesGcmCtrV1&& other362) noexcept {
  aad_prefix = std::move(other362.aad_prefix);
  aad_file_unique = std::move(other362.aad_file_unique);
  supply_aad_prefix = other362.supply_aad_prefix;
...
EncryptionAlgorithm::EncryptionAlgorithm(const EncryptionAlgorithm& other363) {
  AES_GCM_V1 = other363.AES_GCM_V1;
  AES_GCM_CTR_V1 = other363.AES_GCM_CTR_V1;
  __isset = other363.__isset;
}
EncryptionAlgorithm::EncryptionAlgorithm(EncryptionAlgorithm&& other364) noexcept {
  AES_GCM_V1 = std::move(other364.AES_GCM_V1);
  AES_GCM_CTR_V1 = std::move(other364.AES_GCM_CTR_V1);
  __isset = other364.__isset;
}
EncryptionAlgorithm& EncryptionAlgorithm::operator=(const EncryptionAlgorithm& other365) {
  AES_GCM_V1 = other365.AES_GCM_V1;
  AES_GCM_CTR_V1 = other365.AES_GCM_CTR_V1;
  __isset = other365.__isset;
  return *this;
}
EncryptionAlgorithm& EncryptionAlgorithm::operator=(EncryptionAlgorithm&& other366) noexcept {
  AES_GCM_V1 = std::move(other366.AES_GCM_V1);
  AES_GCM_CTR_V1 = std::move(other366.AES_GCM_CTR_V1);
...
FileMetaData::FileMetaData(const FileMetaData& other391) {
  version = other391.version;
  schema = other391.schema;
  num_rows = other391.num_rows;
  row_groups = other391.row_groups;
  key_value_metadata = other391.key_value_metadata;
  created_by = other391.created_by;
  column_orders = other391.column_orders;
  encryption_algorithm = other391.encryption_algorithm;
  footer_signing_key_metadata = other391.footer_signing_key_metadata;
  __isset = other391.__isset;
}
FileMetaData::FileMetaData(FileMetaData&& other392) noexcept {
  version = other392.version;
  schema = std::move(other392.schema);
  num_rows = other392.num_rows;
  row_groups = std::move(other392.row_groups);
  key_value_metadata = std::move(other392.key_value_metadata);
  created_by = std::move(other392.created_by);
  column_orders = std::move(other392.column_orders);
  encryption_algorithm = std::move(other392.encryption_algorithm);
  footer_signing_key_metadata = std::move(other392.footer_signing_key_metadata);
  __isset = other392.__isset;
}
FileMetaData& FileMetaData::operator=(const FileMetaData& other393) {
  version = other393.version;
  schema = other393.schema;
  num_rows = other393.num_rows;
  row_groups = other393.row_groups;
  key_value_metadata = other393.key_value_metadata;
  created_by = other393.created_by;
  column_orders = other393.column_orders;
  encryption_algorithm = other393.encryption_algorithm;
  footer_signing_key_metadata = other393.footer_signing_key_metadata;
  __isset = other393.__isset;
  return *this;
}
FileMetaData& FileMetaData::operator=(FileMetaData&& other394) noexcept {
  version = other394.version;
  schema = std::move(other394.schema);
  num_rows = other394.num_rows;
  row_groups = std::move(other394.row_groups);
  key_value_metadata = std::move(other394.key_value_metadata);
  created_by = std::move(other394.created_by);
  column_orders = std::move(other394.column_orders);
  encryption_algorithm = std::move(other394.encryption_algorithm);
  footer_signing_key_metadata = std::move(other394.footer_signing_key_metadata);
...
FileCryptoMetaData::FileCryptoMetaData(const FileCryptoMetaData& other395) {
  encryption_algorithm = other395.encryption_algorithm;
  key_metadata = other395.key_metadata;
  __isset = other395.__isset;
}
FileCryptoMetaData::FileCryptoMetaData(FileCryptoMetaData&& other396) noexcept {
  encryption_algorithm = std::move(other396.encryption_algorithm);
  key_metadata = std::move(other396.key_metadata);
  __isset = other396.__isset;
}
FileCryptoMetaData& FileCryptoMetaData::operator=(const FileCryptoMetaData& other397) {
  encryption_algorithm = other397.encryption_algorithm;
  key_metadata = other397.key_metadata;
  __isset = other397.__isset;
  return *this;
}
FileCryptoMetaData& FileCryptoMetaData::operator=(FileCryptoMetaData&& other398) noexcept {
  encryption_algorithm = std::move(other398.encryption_algorithm);
  key_metadata = std::move(other398.key_metadata);

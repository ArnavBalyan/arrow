...
template <class Protocol_>
uint32_t DataPageHeaderV3::read(Protocol_* iprot) {
  ...
  bool isset_num_nulls = false;
  bool isset_num_rows = false;
  bool isset_values_encoding = false;
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->values_encoding = static_cast<Encoding::type>(ecast151);
          isset_values_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 5:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->repetition_level_encodings.clear();
            uint32_t _size152;
            ::apache::thrift::protocol::TType _etype155;
            xfer += iprot->readListBegin(_etype155, _size152);
            this->repetition_level_encodings.resize(_size152);
            uint32_t _i156;
            for (_i156 = 0; _i156 < _size152; ++_i156)
            {
              int32_t ecast157;
              xfer += iprot->readI32(ecast157);
              this->repetition_level_encodings[_i156] = static_cast<Encoding::type>(ecast157);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.repetition_level_encodings = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 6:
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            this->definition_level_encodings.clear();
            uint32_t _size158;
            ::apache::thrift::protocol::TType _etype161;
            xfer += iprot->readListBegin(_etype161, _size158);
            this->definition_level_encodings.resize(_size158);
            uint32_t _i162;
            for (_i162 = 0; _i162 < _size158; ++_i162)
            {
              int32_t ecast163;
              xfer += iprot->readI32(ecast163);
              this->definition_level_encodings[_i162] = static_cast<Encoding::type>(ecast163);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.definition_level_encodings = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 7:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->encoding_metadata);
          this->__isset.encoding_metadata = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
  ...
  if (!isset_num_rows)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_values_encoding)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}

template <class Protocol_>
uint32_t DataPageHeaderV3::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageHeaderV3");
  ...
  xfer += oprot->writeFieldBegin("values_encoding", ::apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32(static_cast<int32_t>(this->values_encoding));
  xfer += oprot->writeFieldEnd();

  if (this->__isset.repetition_level_encodings) {
    xfer += oprot->writeFieldBegin("repetition_level_encodings", ::apache::thrift::protocol::T_LIST, 5);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->repetition_level_encodings.size()));
      std::vector<Encoding::type> ::const_iterator _iter164;
      for (_iter164 = this->repetition_level_encodings.begin(); _iter164 != this->repetition_level_encodings.end(); ++_iter164)
      {
        xfer += oprot->writeI32(static_cast<int32_t>((*_iter164)));
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.definition_level_encodings) {
    xfer += oprot->writeFieldBegin("definition_level_encodings", ::apache::thrift::protocol::T_LIST, 6);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->definition_level_encodings.size()));
      std::vector<Encoding::type> ::const_iterator _iter165;
      for (_iter165 = this->definition_level_encodings.begin(); _iter165 != this->definition_level_encodings.end(); ++_iter165)
      {
  ...
  if (this->__isset.encoding_metadata) {
    xfer += oprot->writeFieldBegin("encoding_metadata", ::apache::thrift::protocol::T_STRING, 7);
    xfer += oprot->writeBinary(this->encoding_metadata);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.statistics) {
    xfer += oprot->writeFieldBegin("statistics", ::apache::thrift::protocol::T_STRUCT, 8);
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<PageType::type>(ecast198);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 9:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->data_page_header_v3.read(iprot);
          this->__isset.data_page_header_v3 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t PageHeader::write(Protocol_* oprot) const {
  ...
  if (this->__isset.data_page_header_v3) {
    xfer += oprot->writeFieldBegin("data_page_header_v3", ::apache::thrift::protocol::T_STRUCT, 9);
    xfer += this->data_page_header_v3.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->page_type = static_cast<PageType::type>(ecast211);
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = static_cast<Encoding::type>(ecast212);
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<Type::type>(ecast217);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->encodings.resize(_size218);
            uint32_t _i222;
            for (_i222 = 0; _i222 < _size218; ++_i222)
            {
              int32_t ecast223;
              xfer += iprot->readI32(ecast223);
              this->encodings[_i222] = static_cast<Encoding::type>(ecast223);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->path_in_schema.resize(_size224);
            uint32_t _i228;
            for (_i228 = 0; _i228 < _size224; ++_i228)
            {
              xfer += iprot->readString(this->path_in_schema[_i228]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->codec = static_cast<CompressionCodec::type>(ecast229);
          isset_codec = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->key_value_metadata.resize(_size230);
            uint32_t _i234;
            for (_i234 = 0; _i234 < _size230; ++_i234)
            {
              xfer += this->key_value_metadata[_i234].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->encoding_stats.resize(_size235);
            uint32_t _i239;
            for (_i239 = 0; _i239 < _size235; ++_i239)
            {
              xfer += this->encoding_stats[_i239].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnMetaData::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("encodings", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<Encoding::type> ::const_iterator _iter240;
    for (_iter240 = this->encodings.begin(); _iter240 != this->encodings.end(); ++_iter240)
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter240)));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      std::vector<KeyValue> ::const_iterator _iter242;
      for (_iter242 = this->key_value_metadata.begin(); _iter242 != this->key_value_metadata.end(); ++_iter242)
      {
  ...
  if (this->__isset.encoding_stats) {
    xfer += oprot->writeFieldBegin("encoding_stats", ::apache::thrift::protocol::T_LIST, 13);
    {
      ...
      std::vector<PageEncodingStats> ::const_iterator _iter243;
      for (_iter243 = this->encoding_stats.begin(); _iter243 != this->encoding_stats.end(); ++_iter243)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->path_in_schema.resize(_size252);
            uint32_t _i256;
            for (_i256 = 0; _i256 < _size252; ++_i256)
            {
              xfer += iprot->readString(this->path_in_schema[_i256]);
            }
            xfer += iprot->readListEnd();
          }
          isset_path_in_schema = true;
...
uint32_t EncryptionWithColumnKey::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter257 = this->path_in_schema.begin(); _iter257 != this->path_in_schema.end(); ++_iter257)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->sorting_columns.resize(_size275);
            uint32_t _i279;
            for (_i279 = 0; _i279 < _size275; ++_i279)
            {
              xfer += this->sorting_columns[_i279].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t RowGroup::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("columns", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<ColumnChunk> ::const_iterator _iter280;
  ...
  if (this->__isset.sorting_columns) {
    xfer += oprot->writeFieldBegin("sorting_columns", ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      std::vector<SortingColumn> ::const_iterator _iter281;
      for (_iter281 = this->sorting_columns.begin(); _iter281 != this->sorting_columns.end(); ++_iter281)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->page_locations.resize(_size298);
            uint32_t _i302;
            for (_i302 = 0; _i302 < _size298; ++_i302)
            {
              xfer += this->page_locations[_i302].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->unencoded_byte_array_data_bytes.resize(_size303);
            uint32_t _i307;
            for (_i307 = 0; _i307 < _size303; ++_i307)
            {
              xfer += iprot->readI64(this->unencoded_byte_array_data_bytes[_i307]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.unencoded_byte_array_data_bytes = true;
...
uint32_t OffsetIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("page_locations", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<PageLocation> ::const_iterator _iter308;
    for (_iter308 = this->page_locations.begin(); _iter308 != this->page_locations.end(); ++_iter308)
    {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
    xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      std::vector<int64_t> ::const_iterator _iter309;
      for (_iter309 = this->unencoded_byte_array_data_bytes.begin(); _iter309 != this->unencoded_byte_array_data_bytes.end(); ++_iter309)
      {
        xfer += oprot->writeI64((*_iter309));
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_pages.resize(_size314);
            uint32_t _i318;
            for (_i318 = 0; _i318 < _size314; ++_i318)
            {
              xfer += iprot->readBool(this->null_pages[_i318]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->min_values.resize(_size319);
            uint32_t _i323;
            for (_i323 = 0; _i323 < _size319; ++_i323)
            {
              xfer += iprot->readBinary(this->min_values[_i323]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->max_values.resize(_size324);
            uint32_t _i328;
            for (_i328 = 0; _i328 < _size324; ++_i328)
            {
              xfer += iprot->readBinary(this->max_values[_i328]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = static_cast<BoundaryOrder::type>(ecast329);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_counts.resize(_size330);
            uint32_t _i334;
            for (_i334 = 0; _i334 < _size330; ++_i334)
            {
              xfer += iprot->readI64(this->null_counts[_i334]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->repetition_level_histograms.resize(_size335);
            uint32_t _i339;
            for (_i339 = 0; _i339 < _size335; ++_i339)
            {
              xfer += iprot->readI64(this->repetition_level_histograms[_i339]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->definition_level_histograms.resize(_size340);
            uint32_t _i344;
            for (_i344 = 0; _i344 < _size340; ++_i344)
            {
              xfer += iprot->readI64(this->definition_level_histograms[_i344]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("null_pages", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<bool> ::const_iterator _iter345;
    for (_iter345 = this->null_pages.begin(); _iter345 != this->null_pages.end(); ++_iter345)
    {
      xfer += oprot->writeBool((*_iter345));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("min_values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter346 = this->min_values.begin(); _iter346 != this->min_values.end(); ++_iter346)
    {
  ...
  xfer += oprot->writeFieldBegin("max_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter347 = this->max_values.begin(); _iter347 != this->max_values.end(); ++_iter347)
    {
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter348 = this->null_counts.begin(); _iter348 != this->null_counts.end(); ++_iter348)
      {
  ...
  if (this->__isset.repetition_level_histograms) {
    xfer += oprot->writeFieldBegin("repetition_level_histograms", ::apache::thrift::protocol::T_LIST, 6);
    {
      ...
      for (_iter349 = this->repetition_level_histograms.begin(); _iter349 != this->repetition_level_histograms.end(); ++_iter349)
      {
  ...
  if (this->__isset.definition_level_histograms) {
    xfer += oprot->writeFieldBegin("definition_level_histograms", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      for (_iter350 = this->definition_level_histograms.begin(); _iter350 != this->definition_level_histograms.end(); ++_iter350)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->schema.resize(_size367);
            uint32_t _i371;
            for (_i371 = 0; _i371 < _size367; ++_i371)
            {
              xfer += this->schema[_i371].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_schema = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->row_groups.resize(_size372);
            uint32_t _i376;
            for (_i376 = 0; _i376 < _size372; ++_i376)
            {
              xfer += this->row_groups[_i376].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->key_value_metadata.resize(_size377);
            uint32_t _i381;
            for (_i381 = 0; _i381 < _size377; ++_i381)
            {
              xfer += this->key_value_metadata[_i381].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.key_value_metadata = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->column_orders.resize(_size382);
            uint32_t _i386;
            for (_i386 = 0; _i386 < _size382; ++_i386)
            {
              xfer += this->column_orders[_i386].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t FileMetaData::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<SchemaElement> ::const_iterator _iter387;
    for (_iter387 = this->schema.begin(); _iter387 != this->schema.end(); ++_iter387)
    {
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<RowGroup> ::const_iterator _iter388;
    for (_iter388 = this->row_groups.begin(); _iter388 != this->row_groups.end(); ++_iter388)
    {
  ...
  if (this->__isset.key_value_metadata) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
      std::vector<KeyValue> ::const_iterator _iter389;
      for (_iter389 = this->key_value_metadata.begin(); _iter389 != this->key_value_metadata.end(); ++_iter389)
      {
  ...
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      std::vector<ColumnOrder> ::const_iterator _iter390;
      for (_iter390 = this->column_orders.begin(); _iter390 != this->column_orders.end(); ++_iter390)
      {
